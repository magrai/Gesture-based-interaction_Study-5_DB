--------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION f_t_adtf_scenario_full_aggr_dti_rnd1 (scenario_id INT DEFAULT NULL, event_id INT DEFAULT NULL) 
RETURNS VOID
LANGUAGE plpgsql AS $$
--------------------------------------------------------------------------------
...
BEGIN
RAISE INFO '==================================================';
RAISE INFO 'Processing f_t_adtf_scenario_full_aggr_dti_rnd1';
...
EXECUTE '
--------------------------------------------------------------------------------
DROP TABLE IF EXISTS t_adtf_' ||  index_txt || '_full_dti_rnd1 CASCADE;
CREATE TABLE t_adtf_' ||  index_txt || '_full_dti_rnd1 AS
--------------------------------------------------------------------------------
SELECT
t_adtf_' || index_txt || '_am_dti_rnd1.row_nr,
t_adtf_' || index_txt || '_am_dti_rnd1.subject_id,
t_adtf_' || index_txt || '_am_dti_rnd1.scenario_id,
--------------------------------------------------------------------------------
t_adtf_formatted.time_s,
t_adtf_driven_dist_cum.dist_m,
--------------------------------------------------------------------------------
t_adtf_' || index_txt || '_am_dti_rnd1.'|| index_txt ||'_tti_s,
t_adtf_' || index_txt || '_am_dti_rnd1.'|| index_txt ||'_dti_m_rnd1,
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
FROM
t_adtf_' || index_txt || '_am_dti_rnd1
LEFT JOIN t_adtf_formatted ON 
	t_adtf_' || index_txt || '_am_dti_rnd1.row_nr = t_adtf_formatted.row_nr
LEFT JOIN t_adtf_driven_dist_cum ON 
		t_adtf_' || index_txt || '_am_dti_rnd1.row_nr = t_adtf_driven_dist_cum.row_nr
--------------------------------------------------------------------------------
ORDER BY
t_adtf_' || index_txt || '_am_dti_rnd1.row_nr	
--------------------------------------------------------------------------------
