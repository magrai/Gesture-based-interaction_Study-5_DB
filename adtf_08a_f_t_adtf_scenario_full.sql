...
--------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION f_t_adtf_scenario_full (scenario_id INT DEFAULT NULL, event_id INT DEFAULT NULL) 
RETURNS VOID
LANGUAGE plpgsql AS $$
--------------------------------------------------------------------------------
...
BEGIN
RAISE INFO '==================================================';
RAISE INFO 'Processing f_t_adtf_scenario_full';
...
EXECUTE '
--------------------------------------------------------------------------------
DROP TABLE IF EXISTS t_adtf_' || index_txt || '_full CASCADE;
CREATE TABLE t_adtf_' || index_txt || '_full AS
--------------------------------------------------------------------------------
SELECT
t_adtf_' || index_txt || '_am.row_nr,
t_adtf_' || index_txt || '_am.subject_id,
t_adtf_' || index_txt || '_am.scenario_id,
--------------------------------------------------------------------------------
t_adtf_' || index_txt || '_am.time_s,
t_adtf_' || index_txt || '_am.dist_m,
--------------------------------------------------------------------------------
t_adtf_' || index_txt || '_am.' ||  index_txt || '_tti_s,
t_adtf_' || index_txt || '_am.' ||  index_txt || '_dti_m,
--------------------------------------------------------------------------------
...
LEFT JOIN t_adtf_formatted ON 
	t_adtf_'|| index_txt ||'_am.row_nr 	= t_adtf_formatted.row_nr
--------------------------------------------------------------------------------
ORDER BY
t_adtf_' || index_txt || '_am.row_nr
--------------------------------------------------------------------------------
